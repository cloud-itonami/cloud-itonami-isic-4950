# Operator Quickstart — Transport via pipeline

Shortest path from clone to a verified local dry-run for **ISIC 4950** (`cloud-itonami-isic-4950`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4950.git
cd cloud-itonami-isic-4950
```
...
- Blueprint governor key: `pipeline-integrity-governor`
- Likely source path: `pipeline.governor.cljc`
